  ...
  return (
    <main className="min-h-screen flex items-center justify-center bg-background">
      <article className="text-center animate-fade-in">
        <h1 className="text-4xl font-serifDisplay font-bold mb-4">Welcome to the Ordiem Design Hub for Patched:</h1>
        ...
        <div className="space-y-4">
          ...
          <a href="/listicle" className="story-link text-primary block">✨ 11 Magical Reasons Why Your Soul Needs to Lose Weight</a>
        </div>
      </article>
    </main>
  );
