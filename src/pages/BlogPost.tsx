      ...
      <main className="container max-w-4xl mx-auto px-4 py-8 md:py-12">
        <article className="space-y-8 animate-fade-in">
          ...
          <div className="space-y-4">
            ...
            <p className="text-lg md:text-xl text-muted-foreground leading-relaxed">Millions are paying over $1,000 a month for GLP-1 injections to curb cravings and lose weight. But one pharmacist says a $39.99 alternative can deliver similar appetite-controlling benefits without prescriptions or side effects.</p>
          </div>
